...
public class ItemListAdapter extends RecyclerView.Adapter<ItemListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ItemListAdapter.MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> clickListener.itemClick(itemsList.get(position)));

        holder.editCategory.setOnClickListener(v -> clickListener.editItem(itemsList.get(position)));

        holder.removeCategory.setOnClickListener(v -> clickListener.removeItem(itemsList.get(position)));
